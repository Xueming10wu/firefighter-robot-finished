#ifndef __FlameDetection_Train__FeatureAnalyzer__
#define __FlameDetection_Train__FeatureAnalyzer__
...
#endif /* defined(__FlameDetection_Train__FeatureAnalyzer__) */
