...
public:
    ...
    void calc(const Region& region, const Mat& frame, char LR);
...
private:
    ...
    void targetUpdate(map<int, Target>& targets, char LR);

public:
    void analyze(const Mat& frame, map<int, Target>& targets, char LR);
